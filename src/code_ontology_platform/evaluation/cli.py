...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="code-ontology-eval",
        description="Evaluate Code Ontology planning and pre-commit workflows",
    )
    ...
    run = commands.add_parser("run", help="execute and judge evaluation scenarios")
